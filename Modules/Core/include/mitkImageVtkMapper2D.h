...
#define MITKIMAGEVTKMAPPER2D_POLYDATAMAPPER vtkOpenGLPolyDataMapper

class vtkActor;
class MITKIMAGEVTKMAPPER2D_POLYDATAMAPPER;
...
public:
  ...
  public:
    ...
    vtkSmartPointer<MITKIMAGEVTKMAPPER2D_POLYDATAMAPPER> m_Mapper;
    ...
    vtkSmartPointer<vtkTexture> m_LutTexture;
    vtkSmartPointer<vtkImageCast> m_castFilter;
